...
<br>
 ...
 <p align=center> [**TABLE OF CONTENTS**](https://github.com/SCLW/Circuitry-Based-Sound/blob/master/readme.md#table-of-contents)
***
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Multiplexing](https://github.com/SCLW/Circuitry-Based-Sound/blob/master/readme.md#multiplexing)\
...
<font color="#95a5a6"></font>
<font color="#95a5a6"></font>
<font color="#95a5a6">ADG406</font>
<font color="#95a5a6"></font>
<font color="#95a5a6">Hardware Hookup:</font>
<font color="#95a5a6">Mux Breakout ----------- Arduino</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;A3 ------------------- 2</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;A2 ------------------- 3</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;A1 ------------------- 4</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;A0 ------------------- 5</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;EN ------------------- 6</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;(VCC ------------------- 5V)</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;GND ------------------- GND</font>
<font color="#95a5a6"> &nbsp;&nbsp;&nbsp;(VEE should be connected to GND)</font>
<font color="#95a5a6"></font>
<font color="#95a5a6"></font>
<font color="#95a5a6">******************************************************************************&#47;</font>

<font color="#5e6d03">#define</font> <font color="#00979c">ENCODER_USE_INTERRUPTS</font>
<font color="#5e6d03">#define</font> <font color="#00979c">ENCODER_OPTIMIZE_INTERRUPTS</font>
<font color="#5e6d03">#define</font> <font color="#00979c">INPUT_PULLUP</font>
...
<font color="#5e6d03">#include</font> <font color="#434f54">&lt;</font><b><font color="#d35400">Encoder</font></b><font color="#434f54">.</font><font color="#000000">h</font><font color="#434f54">&gt;</font>


<font color="#434f54">&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;</font>
<font color="#434f54">&#47;&#47; Pin Definitions &#47;&#47;</font>
<font color="#434f54">&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;&#47;</font>
<font color="#00979c">const</font> <font color="#00979c">int</font> <font color="#000000">PIN_A</font><font color="#000000">[</font><font color="#000000">4</font><font color="#000000">]</font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">=</font> <font color="#000000">{</font> <font color="#000000">5</font><font color="#434f54">,</font> <font color="#000000">4</font><font color="#434f54">,</font> <font color="#000000">3</font><font color="#434f54">,</font> <font color="#000000">2</font> <font color="#000000">}</font><font color="#000000">;</font>
<font color="#00979c">const</font> <font color="#00979c">int</font> <font color="#000000">PIN_ENABLE</font> &nbsp;&nbsp;&nbsp;<font color="#434f54">=</font> <font color="#000000">6</font><font color="#000000">;</font>
<font color="#00979c">const</font> <font color="#00979c">int</font> <font color="#000000">PIN_LED</font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">=</font> <font color="#000000">13</font><font color="#000000">;</font>
<font color="#00979c">const</font> <font color="#00979c">int</font> <font color="#000000">PIN_ENCODER_1</font> <font color="#434f54">=</font> <font color="#000000">7</font><font color="#000000">;</font>
<font color="#00979c">const</font> <font color="#00979c">int</font> <font color="#000000">PIN_ENCODER_2</font> <font color="#434f54">=</font> <font color="#000000">8</font><font color="#000000">;</font>
<font color="#00979c">const</font> <font color="#00979c">int</font> <font color="#000000">ENCODER_STEPS</font> <font color="#434f54">=</font> <font color="#000000">24</font><font color="#000000">;</font>

<b><font color="#d35400">Encoder</font></b><font color="#434f54">*</font> <font color="#000000">frequencyEncoder</font> <font color="#434f54">=</font> <font color="#00979c">NULL</font><font color="#000000">;</font>
<font color="#00979c">int</font> <font color="#000000">lastMillis</font> <font color="#434f54">=</font> <font color="#d35400">millis</font><font color="#000000">(</font><font color="#000000">)</font><font color="#000000">;</font>
<font color="#00979c">int</font> <font color="#000000">waitingTimeLeft</font> <font color="#434f54">=</font> <font color="#000000">0</font><font color="#000000">;</font>
<font color="#00979c">int</font> <font color="#000000">muxInput</font> <font color="#434f54">=</font> <font color="#000000">0</font><font color="#000000">;</font>

<font color="#434f54">&#47;&#47; switch to a certain channel (ranging from 0 to 15)</font>
<font color="#00979c">void</font> <font color="#000000">switchMux</font><font color="#000000">(</font><font color="#00979c">int</font> <font color="#000000">channel</font><font color="#000000">)</font>
<font color="#000000">{</font>
 &nbsp;<font color="#434f54">&#47;&#47; &#34;shift&#34; command</font>
 &nbsp;
 &nbsp;<font color="#434f54">&#47;&#47; b000 = 0 &gt;&gt; 1 = 0 = b000 rest 0</font>
 &nbsp;<font color="#434f54">&#47;&#47; b001 = 1 &gt;&gt; 1 = 0 = b000 rest 1</font>
 &nbsp;<font color="#434f54">&#47;&#47; b010 = 2 &gt;&gt; 1 = 1 = b001 rest 0</font>
 &nbsp;<font color="#434f54">&#47;&#47; b011 = 3 &gt;&gt; 1 = 1 = b001 rest 1</font>
 &nbsp;<font color="#434f54">&#47;&#47; b100 = 4 &gt;&gt; 1 = 2 = b010 rest 0</font>
 &nbsp;<font color="#434f54">&#47;&#47; b101 = 5 &gt;&gt; 1 = 2 = b010 rest 1</font>
 &nbsp;<font color="#434f54">&#47;&#47; b110 = 6 &gt;&gt; 1 = 3 = b011 rest 0</font>
 &nbsp;
 &nbsp;<font color="#434f54">&#47;&#47; b0111 = &nbsp;7 &gt;&gt; 2 = 1 = b0001 (shifted out 11)</font>
 &nbsp;<font color="#434f54">&#47;&#47; b1111 = 15 &gt;&gt; 2 = 3 = b0011 (shifted out 11)</font>

 &nbsp;<font color="#434f54">&#47;&#47; b1101 &amp; b0001 = b0001</font>
 &nbsp;<font color="#434f54">&#47;&#47; b1110 &amp; b0001 = b0000</font>

 &nbsp;<font color="#434f54">&#47;&#47; b0011 &lt;&lt; 2 = b1100 = 8+4 = 12</font>
 &nbsp;<font color="#434f54">&#47;&#47; b0001 &lt;&lt; 3 = b1000 = 8</font>

 &nbsp;<font color="#434f54">&#47;&#47; do not route enything anymore</font>
 &nbsp;<font color="#d35400">digitalWrite</font><font color="#000000">(</font><font color="#000000">PIN_ENABLE</font><font color="#434f54">,</font> <font color="#00979c">LOW</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;<font color="#434f54">&#47;&#47; if the switching should not prove to be stable,</font>
 &nbsp;<font color="#434f54">&#47;&#47; please uncomment the following line</font>
 &nbsp;<font color="#434f54">&#47;&#47; delayMicroseconds(1);</font>
 &nbsp;
 &nbsp;<font color="#434f54">&#47;&#47; loop for values of i between 0 and 3 (for all pins)</font>
 ...
 &nbsp;<font color="#000000">{</font>
 &nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; read out bit i of our channel</font>
 &nbsp;&nbsp;&nbsp;<font color="#00979c">int</font> <font color="#000000">setHigh</font> <font color="#434f54">=</font> <font color="#000000">(</font><font color="#000000">(</font><font color="#000000">channel</font> <font color="#434f54">&gt;&gt;</font> <font color="#000000">i</font><font color="#000000">)</font> <font color="#434f54">&amp;</font> <font color="#000000">1</font><font color="#000000">)</font><font color="#000000">;</font> <font color="#434f54">&#47;&#47; results in 0 or 1</font>
 &nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; int setHigh = (channel &amp; (1 &lt;&lt; i)); &#47;&#47; would result in 0 or 2^i</font>
 &nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;<font color="#5e6d03">if</font> <font color="#000000">(</font><font color="#000000">setHigh</font> <font color="#434f54">!=</font> <font color="#000000">0</font><font color="#000000">)</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#d35400">digitalWrite</font><font color="#000000">(</font><font color="#000000">PIN_A</font><font color="#000000">[</font><font color="#000000">i</font><font color="#000000">]</font><font color="#434f54">,</font> <font color="#00979c">HIGH</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;<font color="#5e6d03">else</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#d35400">digitalWrite</font><font color="#000000">(</font><font color="#000000">PIN_A</font><font color="#000000">[</font><font color="#000000">i</font><font color="#000000">]</font><font color="#434f54">,</font> <font color="#00979c">LOW</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;<font color="#000000">}</font>

 &nbsp;<font color="#434f54">&#47;&#47; set enable to high to actually switch</font>
 &nbsp;<font color="#d35400">digitalWrite</font><font color="#000000">(</font><font color="#000000">PIN_ENABLE</font><font color="#434f54">,</font> <font color="#00979c">HIGH</font><font color="#000000">)</font><font color="#000000">;</font>
<font color="#000000">}</font>
...
<font color="#000000">{</font>
 ...
 &nbsp;
 &nbsp;<font color="#434f54">&#47;&#47; set all pins to output</font>
 &nbsp;<font color="#d35400">pinMode</font><font color="#000000">(</font><font color="#000000">PIN_ENABLE</font><font color="#434f54">,</font> <font color="#00979c">OUTPUT</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;<font color="#d35400">digitalWrite</font><font color="#000000">(</font><font color="#000000">PIN_ENABLE</font><font color="#434f54">,</font> <font color="#00979c">LOW</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;
 &nbsp;<font color="#434f54">&#47;&#47; loop for values of i between 0 and 3</font>
 &nbsp;<font color="#5e6d03">for</font> <font color="#000000">(</font><font color="#00979c">int</font> <font color="#000000">i</font> <font color="#434f54">=</font> <font color="#000000">0</font><font color="#000000">;</font> <font color="#000000">i</font> <font color="#434f54">&lt;</font> <font color="#000000">4</font><font color="#000000">;</font> <font color="#000000">i</font><font color="#434f54">++</font><font color="#000000">)</font>
 &nbsp;<font color="#000000">{</font>
 &nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; set relevant mux pin to output</font>
 &nbsp;&nbsp;&nbsp;<font color="#d35400">pinMode</font><font color="#000000">(</font><font color="#000000">PIN_A</font><font color="#000000">[</font><font color="#000000">i</font><font color="#000000">]</font><font color="#434f54">,</font> <font color="#00979c">OUTPUT</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;<font color="#000000">}</font>

 &nbsp;<font color="#434f54">&#47;&#47; initialize frequency encoder</font>
 &nbsp;<font color="#d35400">pinMode</font><font color="#000000">(</font><font color="#000000">PIN_ENCODER_1</font><font color="#434f54">,</font> <font color="#00979c">INPUT</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;<font color="#d35400">pinMode</font><font color="#000000">(</font><font color="#000000">PIN_ENCODER_2</font><font color="#434f54">,</font> <font color="#00979c">INPUT</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;<font color="#000000">frequencyEncoder</font> <font color="#434f54">=</font> <font color="#00979c">new</font> <b><font color="#d35400">Encoder</font></b><font color="#000000">(</font><font color="#000000">PIN_ENCODER_1</font><font color="#434f54">,</font> <font color="#000000">PIN_ENCODER_2</font><font color="#000000">)</font><font color="#000000">;</font>
<font color="#000000">}</font>

<font color="#00979c">void</font> <font color="#5e6d03">loop</font><font color="#000000">(</font><font color="#000000">)</font>
<font color="#000000">{</font>
 &nbsp;<font color="#00979c">int32_t</font> <font color="#000000">encoderPosition</font> <font color="#434f54">=</font> <font color="#000000">frequencyEncoder</font><font color="#434f54">-</font><font color="#434f54">&gt;</font><font color="#d35400">read</font><font color="#000000">(</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;
 &nbsp;<font color="#434f54">&#47;&#47; switch through all channels with a delay</font>
 &nbsp;<font color="#5e6d03">if</font> <font color="#000000">(</font><font color="#000000">waitingTimeLeft</font> <font color="#434f54">&lt;=</font> <font color="#000000">0</font><font color="#000000">)</font>
 &nbsp;<font color="#000000">{</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">lastMillis</font> <font color="#434f54">=</font> <font color="#d35400">millis</font><font color="#000000">(</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; switch to the channel we desire</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">switchMux</font><font color="#000000">(</font><font color="#000000">muxInput</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">muxInput</font> <font color="#434f54">=</font> <font color="#000000">(</font><font color="#000000">muxInput</font> <font color="#434f54">+</font> <font color="#000000">1</font><font color="#000000">)</font> <font color="#434f54">%</font> <font color="#000000">16</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#00979c">double</font> <font color="#000000">fullRotations</font> <font color="#434f54">=</font> <font color="#000000">(</font><font color="#00979c">double</font><font color="#000000">)</font> <font color="#000000">encoderPosition</font> <font color="#434f54">&#47;</font> <font color="#000000">(</font><font color="#00979c">double</font><font color="#000000">)</font> <font color="#000000">ENCODER_STEPS</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; calculate wait time in seconds (starting at 1 second and halving&#47;doubling per rotation left&#47;right)</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#00979c">double</font> <font color="#000000">waitSeconds</font> <font color="#434f54">=</font> <font color="#d35400">pow</font><font color="#000000">(</font><font color="#000000">2.0</font><font color="#434f54">,</font> <font color="#000000">fullRotations</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; Serial.println((float) waitSeconds);</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; caluclate wait time in milliseconds</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">waitingTimeLeft</font> <font color="#434f54">+=</font> <font color="#000000">(</font><font color="#00979c">int</font><font color="#000000">)</font> <font color="#000000">(</font><font color="#000000">1000.0</font><font color="#434f54">*</font><font color="#000000">waitSeconds</font> <font color="#434f54">+</font> <font color="#000000">0.5</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; limit waiting time&#39;s lower bound (mux dependent)</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#5e6d03">if</font> <font color="#000000">(</font><font color="#000000">waitingTimeLeft</font> <font color="#434f54">&lt;</font> <font color="#000000">1</font><font color="#000000">)</font>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">waitingTimeLeft</font> <font color="#434f54">=</font> <font color="#000000">1</font><font color="#000000">;</font>
 &nbsp;<font color="#000000">}</font>
 &nbsp;<font color="#5e6d03">else</font>
 &nbsp;<font color="#000000">{</font>
 &nbsp;&nbsp;&nbsp;<font color="#434f54">&#47;&#47; reduce waiting time by time that elapsed since last call of loop()</font>
 &nbsp;&nbsp;&nbsp;<font color="#00979c">int</font> <font color="#000000">newMillis</font> <font color="#434f54">=</font> <font color="#d35400">millis</font><font color="#000000">(</font><font color="#000000">)</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;<font color="#5e6d03">if</font> <font color="#000000">(</font><font color="#000000">newMillis</font> <font color="#434f54">&gt;</font> <font color="#000000">lastMillis</font><font color="#000000">)</font> <font color="#000000">waitingTimeLeft</font> <font color="#434f54">-=</font> <font color="#000000">newMillis</font><font color="#434f54">-</font><font color="#000000">lastMillis</font><font color="#000000">;</font>
 &nbsp;&nbsp;&nbsp;<font color="#000000">lastMillis</font> <font color="#434f54">=</font> <font color="#000000">newMillis</font><font color="#000000">;</font>
 &nbsp;<font color="#000000">}</font>
<font color="#000000">}</font>
